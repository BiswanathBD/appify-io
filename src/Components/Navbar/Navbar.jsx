  ...
  return (
    <div className="container mx-auto px-4 flex justify-between items-center my-4">
      <div className="flex gap-4 items-center">
        ...
        {/* Mobile Nav */}
        <ul
          className={`md:hidden absolute bg-white p-8 border border-purple-300 rounded-xl flex flex-col gap-8 top-4 left-4 shadow-2xl text-purple-500 text-lg font-medium ${
